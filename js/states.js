$(document).ready(function () {
    ...
    $(".state").change(function () {
        ...
        if ($val == 'Orissa') {
            var orissa = ["Bahabal Pur", "Bhubaneswar", "Chandbali", "Gopalpur", "Jeypore", "Paradip Garh", "Puri", "Rourkela", "Balasore"];
            $(function () {
                var options = '';
        ...
        if ($val == 'Uttar Pradesh') {
            var up = ["Agra", "Aligarh","Allahabad", "Auraiya", "Banbasa", "Bareilly", "Berhni", "Bhadohi", "Dadri", "Dharchula",  "Farrukhabadh","Gandhar", "Gauriphanta", "Ghaziabad", "Gorakhpur", "Gunji",
